...
class UserNotes:
    ...
    def get_json(self, attempts=None):
        ...
        if (time.time() - self.cache_timeout) > self.r.config.cache_timeout + 1:
            ...
            #HTTPError handling
            #If a 403 error - throw a PuniPermissionError
            ...
            try:
                ...
                if e.response.status_code == 403:
                    ...
                    raise PuniPermissionError('No wiki permission')
                    ...
                    temp_json['constants']['users'] = [x.name for x in self.subreddit.get_moderators()]
